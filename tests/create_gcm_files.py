...
def create_emars_test():
    ...
    lonv_var = ('lonv', 'f4', ('lonv',))
    lat_var = ('lat', 'f4', ('lat',))
    ak_var = ('ak', 'f4', ('phalf',))
    bk_var = ('bk', 'f4', ('phalf',))
    phalf_var = ('phalf', 'f4', ('phalf',))
    latu_var = ('latu', 'f4', ('latu',))
    lon_var = ('lon', 'f4', ('lon',))
    Ls_var = ('Ls', 'f4', ('time',))
    MY_var = ('MY', 'f4', ('time',))
    earth_year_var = ('earth_year', 'f4', ('time',))
    earth_month_var = ('earth_month', 'f4', ('time',))
    earth_day_var = ('earth_day', 'f4', ('time',))
    earth_hour_var = ('earth_hour', 'f4', ('time',))
    earth_minute_var = ('earth_minute', 'f4', ('time',))
    earth_second_var = ('earth_second', 'f4', ('time',))
    emars_sol_var = ('emars_sol', 'f4', ('time',))
    macda_sol_var = ('macda_sol', 'f4', ('time',))
    mars_hour_var = ('mars_hour', 'f4', ('time',))
    mars_soy_var = ('mars_soy', 'f4', ('time',))
    time_var = ('time', 'f4', ('time',))
    pfull_var = ('pfull', 'f4', ('pfull',))
    ...
    earth_day_values = generate_earth_days(1104)
    earth_hour_values = generate_earth_hours(1104)
    earth_minute_values = generate_earth_minutes(1104)
    ...
    earth_day_var[:] = earth_day_values
    earth_hour_var[:] = earth_hour_values
    earth_minute_var[:] = earth_minute_values
