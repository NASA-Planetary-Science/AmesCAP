...
def create_marswrf_test():
    ...
    create_var('RDX', ('Time',), '', 8.5e-06, 8.5e-06, "INVERSE X GRID LENGTH")
    create_var('RDY', ('Time',), '', 8.5e-06, 8.5e-06, "INVERSE Y GRID LENGTH")
    create_var('CF1', ('Time',), '', 1.6, 1.6, "2nd order extrapolation constant")
    create_var('CF2', ('Time',), '', -0.7, -0.7, "2nd order extrapolation constant")
    create_var('CF3', ('Time',), '', 0.1, 0.1, "2nd order extrapolation constant")
    create_var('ITIMESTEP', ('Time',), '', 9.6e+05, 2.4e+06, "")
    create_var('XTIME', ('Time',), 'minutes', 9.6e+05, 2.4e+06, "minutes since simulation start")
    create_var('JULIAN', ('Time',), 'days', 0.0, 668.0, "day of year, 0.0 at 0Z on 1 Jan.")
    create_var('L_S', ('Time',), 'degrees', 4.6, 360.0, "Planetocentric solar Longitude")
    ...
    create_var('DECLIN', ('Time',), 'radians', -0.4, 0.4, "SOLAR DECLINATION")
    create_var('SOLCON', ('Time',), 'W m-2', 492.8, 716.7, "SOLAR CONSTANT")
    ...
    create_var('SUNBODY', ('Time',), '', 1.4, 1.7, "Sun-planet distance in AU")
    ...
    create_var('P_FIT_M', ('Time',), 'unitless', 1.1, 1.1, "SCALING OF P FOR CORRECT MASS")
    create_var('P_TOP', ('Time',), 'Pa', 0.00568, 0.00568, "PRESSURE TOP OF THE MODEL")
