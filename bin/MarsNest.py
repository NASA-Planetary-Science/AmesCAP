...
parser = argparse.ArgumentParser(
    ...
    description=(
        ...
        f"Requires external topography file that can be downloaded with\n"
        f"the NASA Ames GCM at: https://github.com/nasa/AmesGCM.git\n"
        f"{Nclr}\n\n"
    ),
...
try:
    ...
    map_dir = input("Enter path to mars topography file. Example: AmesGCM/data/mars_topo_mola16.nc\n> ")
    print(f"Topography file: {map_dir}")
...
try:
    ...
    map_dir=None
    nx, ny = 181, 91  # number of points in x (lon) and y (lat) directions
